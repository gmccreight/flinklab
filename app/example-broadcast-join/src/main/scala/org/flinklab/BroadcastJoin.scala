...
import org.flinklab.util.{SensorReading, SensorSource, SensorTimeAssigner}
...
object BroadcastJoin {
  ...
  def main(args: Array[String]) {
    ...
    alerts.writeAsText("/tmp/ebj_alerts", org.apache.flink.core.fs.FileSystem.WriteMode.OVERWRITE)
