...
public class Demo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        debits.writeAsText("/tmp/debits", org.apache.flink.core.fs.FileSystem.WriteMode.OVERWRITE).setParallelism(1);
        ...
        credits.writeAsText("/tmp/credits", org.apache.flink.core.fs.FileSystem.WriteMode.OVERWRITE).setParallelism(1);
        ...
        balance.writeAsText("/tmp/balance", org.apache.flink.core.fs.FileSystem.WriteMode.OVERWRITE).setParallelism(1);
