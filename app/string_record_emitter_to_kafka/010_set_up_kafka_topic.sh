...
$(git rev-parse --show-toplevel)/bin/kafka topics --delete --topic string-record-emitter-out --if-exists
...
$(git rev-parse --show-toplevel)/bin/kafka topics --create --topic string-record-emitter-out
